...
public class BinaryTree<E> {
     ...
     * @return
     */
    private String preOrderTraverse(Node<E> node, int depth,
                                    StringBuilder sb) {
    ...
    private void preOrderTraverse(Node<E> currentRoot,
        ...
        currentResultSB.append(currentRoot.toString()).append(" ");
    ...
    private int size(Node<E> currentRoot) {
        ...
        int lsize=size(currentRoot.left);
        int rsize=size(currentRoot.right);
    ...
    private int height(Node<E> currentRoot) {
        ...
        int lheight= height(currentRoot.left);
        int rheight= height(currentRoot.right);
